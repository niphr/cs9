...
## Complete Example: Weather Surveillance Task

We will now go through a complete example of how a person would design and implement a weather surveillance task.
...
#> $data
#> {xml_document}
#> <weatherdata noNamespaceSchemaLocation="https://schema.api.met.no/schemas/weatherapi-0.4.xsd" created="2025-08-20T12:50:04Z" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
#> [1] <meta>\n  <model name="met_public_forecast" termin="2025-08-20T12:00:00Z" runended="2025-08-20T12:29:48Z ...
#> [2] <product class="pointData">\n  <time datatype="forecast" from="2025-08-20T12:00:00Z" to="2025-08-20T12:0 ...
#> 
#> $hash
#> $hash$current
...
#>          date     tg    tx    tn
#>        <Date> <lgcl> <num> <num>
#> 1: 2025-08-21     NA  15.6   8.0
#> 2: 2025-08-22     NA  15.9   7.5
...
#>    granularity_time granularity_geo country_iso3 location_code border    age    sex isoyear isoweek
#>              <char>          <char>       <char>        <char>  <int> <char> <char>   <int>   <int>
#> 1:              day          county          nor      county03   2020  total  total      NA      NA
#> 2:              day          county          nor      county03   2020  total  total      NA      NA
#> 3:              day          county          nor      county03   2020  total  total      NA      NA
#> 4:              day          county          nor      county03   2020  total  total      NA      NA
#> 5:              day          county          nor      county03   2020  total  total      NA      NA
#> 6:              day          county          nor      county03   2020  total  total      NA      NA
#> 7:              day          county          nor      county03   2020  total  total      NA      NA
#> 8:              day          county          nor      county03   2020  total  total      NA      NA
#> 9:              day          county          nor      county03   2020  total  total      NA      NA
#>    isoyearweek season seasonweek calyear calmonth calyearmonth       date     tg    tx    tn
#>         <char> <char>      <num>   <int>    <int>       <char>     <Date> <lgcl> <num> <num>
#> 1:        <NA>   <NA>         NA      NA       NA         <NA> 2025-08-21     NA  15.6   8.0
#> 2:        <NA>   <NA>         NA      NA       NA         <NA> 2025-08-22     NA  15.9   7.5
#> 3:        <NA>   <NA>         NA      NA       NA         <NA> 2025-08-23     NA  16.1   7.8
#> 4:        <NA>   <NA>         NA      NA       NA         <NA> 2025-08-24     NA  17.2  10.3
#> 5:        <NA>   <NA>         NA      NA       NA         <NA> 2025-08-25     NA  18.0   8.9
#> 6:        <NA>   <NA>         NA      NA       NA         <NA> 2025-08-26     NA  18.8   9.0
#> 7:        <NA>   <NA>         NA      NA       NA         <NA> 2025-08-27     NA  18.9   9.7
#> 8:        <NA>   <NA>         NA      NA       NA         <NA> 2025-08-28     NA  19.8   9.8
#> 9:        <NA>   <NA>         NA      NA       NA         <NA> 2025-08-29     NA  20.5  10.3
