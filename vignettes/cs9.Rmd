...
## Getting Started with CS9

Now that you understand CS9's architecture and concepts, you're ready to start using it:

- **Installation and Setup**: See `vignette("installation")` for complete installation instructions, database configuration, and environment setup
- **Package Structure**: See `vignette("file-layout")` for detailed guidance on organizing your CS9 implementation files  
- **Creating Tasks**: See `vignette("creating-a-task")` for a step-by-step tutorial on implementing your first surveillance task
...
As documented in more detail [here](https://niphr.github.io/csdb/reference/DBTable_v9.html), we create a database table that fits our needs (recording weather data), and we then add it to the surveillance system.
