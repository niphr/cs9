...
Before creating tasks, ensure CS9 is properly configured with database access. You can check your setup with:
...
- `?check_environment_setup` - Environment configuration guide
