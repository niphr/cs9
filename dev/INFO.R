...
For this tutorial you should clone [GitHub repo](https://github.com/sykdomspulsen-org/sc-tutorial-start) to your server. This will be the package that you will be working on throughout this tutorial. You may choose to do a global find/replace on `sc-tutorial-start` with the name you want for your R package. We will refer to this R package as your "sc implementation".
...
devtools::load_all(".")
```
It you are wokring in the sykdomspulsen infrastructure you might see a warning message on the form: sh: `1: /bin/authenticate.sh: not found`. This has to do with authentication beeing done automatically on sign in. You do not have to worry about this for the purpose of this tutorial. You might also see a warnign starting with "Objects listed as exports, but not present in namespace:". This can also be ignored.
...
```{r, echo=FALSE}
options(width = 150)
x <- fhiplot::as_github_code("https://raw.githubusercontent.com/sykdomspulsen-org/sc-tutorial-end/main/R/03_db_schemas.r")
...
```{r, echo=FALSE}
options(width = 150)
x <- fhiplot::as_github_code("https://github.com/sykdomspulsen-org/sc-tutorial-end/blob/main/R/04_tasks.r")
...
```{r, echo=FALSE}
options(width = 150)
x <- fhiplot::as_github_code("https://github.com/sykdomspulsen-org/sc-tutorial-end/blob/main/R/weather_download_and_import_rawdata.r")
...
```{r, echo=FALSE}
options(width = 150)
x <- fhiplot::as_github_code("https://github.com/sykdomspulsen-org/sc-tutorial-end/blob/main/R/weather_clean_data.r")
...
```{r, echo=FALSE}
options(width = 150)
x <- fhiplot::as_github_code("https://github.com/sykdomspulsen-org/sc-tutorial-end/blob/main/R/weather_export_plots.r")
...
If you save, restart and load all all packages you can now see which schemas have been loaded by running `sc::tm_get_schema_names()`. You can now see that the schemas you made are included.
...
You can alsp see which tasks have been loaded by running `sc::tm_get_task_names()`. These tasks are included in the skeleton.
