...
principle: you write your analytical code as if processing a single
scenario (one disease, one location, one time period), then define the
iteration scope through plans. CS9 automatically expands your
single-instance code across all specified combinations, handling
