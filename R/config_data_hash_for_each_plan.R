update_config_data_hash_for_each_plan <- function(
  task,
  index_plan,
  element_tag,
  element_hash = NULL,
...
#'
#' @export
get_config_data_hash_for_each_plan <- function(
  task = NULL,
  index_plan = NULL,
  element_tag = NULL
) {
...
get_last_run_data_hash_split_into_plnr_format <- function(
  task,
  index_plan,
  expected_element_tags = NULL
) {
  datetime <- NULL

  hash <- get_config_data_hash_for_each_plan(
    task = task,
    index_plan = index_plan
  )
  retval <- list()
